...
<section class="container mx-auto p-6 font-mono">
  ...
  <div class="flex justify-between items-center p-3">
      ...
      <div>
        <a class="flex justify-center uppercase bg-blue-500 w-40 py-3 rounded-xl text-white shadow-xl hover:shadow-inner focus:outline-none transition duration-500 ease-in-out  transform hover:-translate-x hover:scale-105">
          new post
        </a>
      </div>
    </div>
